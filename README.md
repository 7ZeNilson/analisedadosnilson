...
![Frequência e Valor Monetário](analisedadosnilson/frequencia_valor_monetario.png)

![Distribuição da Recência dos Clientes](analisedadosnilson/Recencia_de_Clientes.png)
